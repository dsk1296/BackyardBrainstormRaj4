...
public class ProductListAdapter extends RecyclerView.Adapter<ProductListAdapter.SubtypeViewHolder> {
    ...
    public ProductListAdapter(List<Type> listCategories, Context context, String typeName) {
